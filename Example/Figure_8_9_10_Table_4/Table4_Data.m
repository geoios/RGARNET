function [FigSet] = Table4_Data(ResPath1,ResPath2,ResPath3,ResPath4,ResPath5,ResPath6,ResPath7,ResPath8,ResPath9,ResPath10)
%% 
...
FigSet.StorgePath = 'Table_4_Displacement_time_series_analysis_results_with_different_constraints.csv';
end
